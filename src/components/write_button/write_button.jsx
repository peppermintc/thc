                  ...
                  >
                    <MenuItem onClick={handleClose}>
                      ...
                      <div className={styles.menuItemContainer}>
                        <div className={styles.title}>사진 올리기</div>
                    ...
                    <MenuItem onClick={handleClose}>
                      ...
                      <div className={styles.menuItemContainer}>
                        <div className={styles.title}>집들이 글쓰기</div>
                        <span className={styles.description}>
                          집에 관한 이야기를 글로 작성해보세요.
                        </span>
                      </div>
                    </MenuItem>
                    <MenuItem onClick={handleClose}>
                      ...
                      <div className={styles.menuItemContainer}>
                        <div className={styles.title}>영상집들이 글쓰기</div>
                        <span className={styles.description}>
                          집에 관한 이야기를 영상으로 작성해보세요.
                        </span>
                      </div>
                    </MenuItem>
                    <MenuItem onClick={handleClose}>
                      ...
                      <div className={styles.menuItemContainer}>
                        <div className={styles.title}>노하우 글쓰기</div>
                        <span className={styles.description}>
                          다양한 인테리어 노하우를 공유해주세요.
                        </span>
                      </div>
                    </MenuItem>
                    <MenuItem onClick={handleClose}>
                      ...
                      <div className={styles.menuItemContainer}>
                        <div className={styles.title}>상품 리뷰 쓰기</div>
                        <span className={styles.description}>
                    ...
                    <MenuItem onClick={handleClose}>
                      ...
                      <div className={styles.menuItemContainer}>
                        <div className={styles.title}>시공 전문가 리뷰쓰기</div>
                        <span className={styles.description}>
                    ...
                    <MenuItem onClick={handleClose}>
                      ...
                      <div className={styles.menuItemContainer}>
                        <div className={styles.title}>인테리어 질문하기</div>
                        <span className={styles.description}>
                          인테리어 고수들과 전문가들에게 질문해보세요.
                        </span>
                      </div>
                    </MenuItem>
                    <MenuItem onClick={handleClose}>
